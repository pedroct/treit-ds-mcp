...
## Repository map
- `BRAND_COLORS_UPDATE.md/` — explain what lives here and when agents should edit it.
- `certificados_cloudflare.txt/` — explain what lives here and when agents should edit it.
...
- `DEPLOY_SSL_NGINX_SUCESSO.md/` — explain what lives here and when agents should edit it.
- `DEPLOY_SSL_NGINX.md/` — explain what lives here and when agents should edit it.
- `DEPLOY_SSL_VPS.md/` — explain what lives here and when agents should edit it.
- `DEPLOYMENT_GITHUB_ACTIONS.md/` — explain what lives here and when agents should edit it.
