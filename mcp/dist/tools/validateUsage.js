...
function findSpacingIssues(code) {
    const issues = [];
...
function findComponentIssues(code) {
    const issues = [];
...
export function validateUsage(input) {
    const issues = [
